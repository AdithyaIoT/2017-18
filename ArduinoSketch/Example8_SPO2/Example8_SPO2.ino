...
//        Serial.println("I am inside Heart beat calc");
//        //We sensed a beat!
...
//     }
      ...
      float temparature = particleSensor.readTemperatureF();
      Serial.print(F(", Temparature in Farenheit="));
      Serial.println(temparature, DEC);
